...
def agent_openai_desc_transform(agent_dict: Dict[str, Any], tools: Dict[str, Any] = None) -> List[Dict[str, Any]]:
...
def tool_openai_desc_transform(tool_dict: Dict[str, Any], tools: Dict[str, Any] = None) -> List[Dict[str, Any]]:
