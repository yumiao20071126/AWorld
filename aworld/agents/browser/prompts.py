...
class SystemPrompt:
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			with importlib.resources.files('agents.browser_agents').joinpath('system_prompt.md').open('r') as f:
...
class AgentMessagePrompt:
	...
	def get_user_message(self, use_vision: bool = True) -> HumanMessage:
		elements_text = self.state.dom_tree.element_tree.clickable_elements_to_string(include_attributes=self.include_attributes)
