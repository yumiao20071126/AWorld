"""
Async version of Base Event class definition.
"""
import uuid
import time
import json
...
class AsyncEvent:
    """
    Async version of Base Event class that can be inherited by other event classes.
