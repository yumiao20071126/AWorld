...
from examples.agent.android.prompts import SYSTEM_PROMPT, LAST_STEP_PROMPT
from examples.agent.android.utils import (
    AgentState,
    AgentHistory,
    AgentHistoryList,
    ActionResult,
...
from examples.agent.browsers.common import AgentStepInfo
